...
const SingleUser = (props) => {
    ...
    return(
        <SingleWrap>
            <div className="der">
                <h1 className="titleP">{user.username}</h1>
                <div className="contenido">
                    ...
                    <div className="contDer">
                        <p>{user.nombreUser}</p>
                        <p>{user.apellidoUser}</p>
                        <p>{user.rol}</p>
                    </div>
                </div>
                <div className="btnExtras">
                    <Link to={`/user/editar-user/${id}`} className="btnLink">Editar</Link>
                    <button onClick={eliminarUser} className="btn">Borrar</button>
                </div>
            </div>  
...
`
export default layout (SingleUser);